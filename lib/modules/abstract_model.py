...
class DrawModel(nn.Module):
    ...
    def inference(self, input_inds, input_lens, start_step, explore_rate, explore_mode, ref_inds,index,ind_lens):
        """
        Inputs: 
    ...
    def forward(self, input_inds, input_lens, start_step, explore_rate, explore_mode, ref_inds,index,ind_lens):
        return self.inference(input_inds, input_lens, start_step, explore_rate, explore_mode, ref_inds,index,ind_lens)

    def teacher_forcing(self, input_inds, input_lens, input_bg_imgs, input_fg_onehots, input_hmaps, index, ind_lens):
